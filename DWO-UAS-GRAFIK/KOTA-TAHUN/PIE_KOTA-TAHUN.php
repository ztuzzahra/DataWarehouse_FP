<?php
	...
	//query untuk ambil penjualan di nama kota berdasarkan tahun (clean)
...
Highcharts.chart('container', {
    ...
    subtitle: {
        text: 'Klik bar untuk melihat detil nilai penjualan perkota berdasarkan tahun'
    },
   accessibility: {
		announceNewData: {
			enabled: true
