<?php
	...
	$kategori = $conn->query("SELECT CONCAT('name:',t.tahun) as name, CONCAT('y:', SUM(fp.amount)) as y, CONCAT('drilldown:', t.tahun) as drilldown 
		FROM time t 
...
Highcharts.chart('container', {
    ...
    subtitle: {
        text: 'Klik bar untuk melihat detil nilai penjualan pertahun berdasarkan ketegori'
    },
   accessibility: {
		announceNewData: {
			enabled: true
