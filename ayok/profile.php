    ...
    <li class="nav-item">
      ...
      <ul class="dropdown-menu dropdown-menu-right">
       <li class="dropdown-item user-details">
        <a href="javaScript:void();"><a href="index.php?page=profile">   <div class="media">
             <div class="avatar"><img class="align-self-start mr-3" src="https://via.placeholder.com/110x110" alt="user avatar"></div>
            <div class="media-body">
            <h6 class="mt-2 user-title"><?php echo $username; ?></h6>
            <p class="user-subtitle">Sakila@example.com</p>
            </div>
           </div>
          </a>
        </li>
        ...
        <div class="col-lg-4">
           <div class="card profile-card-2">
            ...
            <div class="card-body pt-5">
                ...
                <p class="card-text">Akun ini dikelola oleh tim DWO yang beranggotakan :</p>
                <li>Baitun Nadhiroh   (18082010004)</li>
                <li>Zabrina Tuzzahra  (18082010030)</li>
                <li>Rahayu KPW        (18082010038)</li>
                <br>
                ...
                <div class="tab-pane active" id="profile">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h6>About</h6>
                            <p>
                                Web eksekutif ini dibuat guna pemenuhan tugas UAS data warehouse.
                            </p>
                            <h6>Hobbies</h6>
                            <p>
                                Membaca, ngoding, kuliner, travel.
                            </p>
                        </div>
                        <div class="col-md-6">
                            <h6>Recent badges</h6>
                            ...
                            <hr>
                            <span class="badge badge-primary"><i class="fa fa-user"></i> 38RB Followers</span>
